...
**Hinweis Regulatorik:** Handwerksordnung (Anlage A, Meisterpflicht), Hygiene-Verordnungen der Bundesländer, ChemVerbotsV bei Färbungs-/Bleichmitteln, Tariftreue bei sozialversicherungspflichtiger Beschäftigung, TSE-Kassenpflicht.

| Funktionsbereich | KI-Use-Case | Reifegrad | Anmerkung |
| --- | --- | --- | --- |
| Geschäftsleitung & Strategie | Marktbeobachtung (Trend-Stylings, Saison) | PR | konvergent |
| Geschäftsleitung & Strategie | Liquiditäts-Forecasting | EE | konvergent |
| Marketing & Kommunikation | Webseite und Stylings-Galerie | PR | konvergent |
| Marketing & Kommunikation | Social-Media-Posts (Vorher-Nachher, Trends) | PR | konvergent |
| Marketing & Kommunikation | Lokales SEO und Google-Business-Pflege | PR | konvergent |
| Vertrieb & Angebote | Online-Buchung mit Wunsch-Stylist und Wunsch-Service | PR | branchenspezifisch |
| Vertrieb & Angebote | Saison-Pakete (Festtag, Hochzeit, Schulanfang) | PR | branchenspezifisch |
| Vertrieb & Angebote | Stilberatungs-Chat (Schnitt, Farbe, Gesichtsform) | PR | branchenspezifisch |
| Verwaltung & Personal | Rechnungserstellung und TSE-Auswertung | PR | branchenspezifisch |
| Verwaltung & Personal | Schichtplanung (Stoßzeiten, Termine) | EE | konvergent |
...
| Operatives Kerngeschäft | Bestandsoptimierung (Färbung, Pflegeprodukte) | EE | branchenspezifisch |
