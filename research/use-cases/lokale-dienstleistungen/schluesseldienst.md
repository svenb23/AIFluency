...
**Hinweis Regulatorik:** Preisangabenverordnung (PAngV) mit Pflicht zur Vorabkostenangabe, Verbraucherschutz bei Notdienst-Aufträgen, Bundesverband Deutscher Schlüssel-/Sicherheits-Firmen (BdSF), TSE-Kassenpflicht.

| Funktionsbereich | KI-Use-Case | Reifegrad | Anmerkung |
| --- | --- | --- | --- |
| Geschäftsleitung & Strategie | Marktbeobachtung (Schloss-Technologien, smart locks) | PR | konvergent |
| Geschäftsleitung & Strategie | Liquiditäts-Forecasting | EE | konvergent |
| Marketing & Kommunikation | Webseite mit transparenten Preisen (PAngV) | PR | branchenspezifisch |
| Marketing & Kommunikation | Lokales SEO und Google-Business-Pflege | PR | konvergent |
| Marketing & Kommunikation | Anti-Abzocke-Aufklärung als Kundenvertrauen | PR | branchenspezifisch |
| Vertrieb & Angebote | Notdienst-Erstgesprächs-Bot mit Vorabpreis (PAngV) | EE | branchenspezifisch |
| Vertrieb & Angebote | Standorthof- und Anfahrtspauschal-Kalkulator | PR | branchenspezifisch |
...
| Operatives Kerngeschäft | No-Show-Prädiktion bei Terminaufträgen | EE | konvergent |
